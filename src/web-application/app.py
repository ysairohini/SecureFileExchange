...
def download_public_key(username):
	for root,dirs,files in os.walk('C:/Users/sxr200143/Documents/GitHub/FileTransfer/src/web-application/media/public-keys/'):
		for file in files:
			list = file.split('-')
			if list[0] == username:
...
def downloads_pk():
	username = []
	if(os.path.isfile("C:/Users/sxr200143/Documents/GitHub/FileTransfer/src/web-application/media/database/database_1.pickle")):
		pickleObj = open("C:/Users/sxr200143/Documents/GitHub/FileTransfer/src/web-application/media/database/database_1.pickle","rb")
...
<<<<<<< HEAD
		...
		public = request.values['publicKey']
		private = request.values['privateKey']
...
def register_user():
	...
	if(os.path.isfile("C:/Users/sxr200143/Documents/GitHub/FileTransfer/src/web-application/media/database/database.pickle")):
		pickleObj = open("C:/Users/sxr200143/Documents/GitHub/FileTransfer/src/web-application/media/database/database.pickle","rb")
	...
	#Save/update pickle
	pickleObj = open("C:/Users/sxr200143/Documents/GitHub/FileTransfer/src/web-application/media/database/database.pickle","wb")
	pickle.dump(privatekeylist,pickleObj)
	pickleObj.close()
	pickleObj = open("C:/Users/sxr200143/Documents/GitHub/FileTransfer/src/web-application/media/database/database_1.pickle","wb")
